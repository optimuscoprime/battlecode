package team219;
/*
Based largely on the example swarm2 player from lecture slides but:
- If injured, go to a medbay or capture one.
- For encampments: 
   -If adjacent to medbay, make artillery
   -If many enemies sensed, but not too close, make artillery.
- Artillery.  It's dumb, it shoots the nearest enemy (Friendlyfire)
